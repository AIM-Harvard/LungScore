...
from .models import lungscore_load # step 4: load model in eval mode with weights
from .models import lungscore_predict #step 5: predict ai lung score 
from .utils import predict_lungscore_riskcategory #step 6: predict risk group based on lung score thresholds

def AILungscorepredict(NRRD):
    ...
    Returns:
        ai_lung_score (float): lung score from 0 to 1 -- 1 is most healthy
    ...
    return ai_lung_score, risk_group 